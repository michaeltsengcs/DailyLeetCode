// source code.cpp : the main fucntion is here, which works as the entrance of the application.
//
...
/*
string s = "My name is Michael Tseng";
Reverse_Words_in_a_String rIvr;
rIvr.reverseWords(s);
cout << s;
*/
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	Word_Break function;
	bool bTemp = function.wordBreak(s, dict);
	cout << bTemp;
	return 0;
}
